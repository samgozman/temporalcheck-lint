...
// nolintForLossynumber reports whether a comment is a golangci-lint nolint
...
// this analyzer by -- not the analyzer name "lossynumber"), ignoring any trailing
// "// explanation".
func nolintForLossynumber(text string) bool {
...
// nolintInfo records where lossynumber nolint directives appear in a file.
