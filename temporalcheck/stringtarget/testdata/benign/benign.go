...
// enabled: a non-selector call, a selector into a non-Temporal package, a
// function-reference target (the form we want), and a workflow-package function
// that isn't an Execute* entry point. None of these produce diagnostics.
package benign
