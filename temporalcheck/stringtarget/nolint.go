...
// nolintForStringtarget reports whether a comment is a golangci-lint nolint
...
// knows this analyzer by -- not the analyzer name "stringtarget"), ignoring any
// trailing "// explanation".
func nolintForStringtarget(text string) bool {
...
// nolintInfo records where stringtarget nolint directives appear in a file.
...
// anchors (the string target argument) including calls written across several
// lines.
