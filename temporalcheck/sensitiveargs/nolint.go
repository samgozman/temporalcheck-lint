...
// nolintForSensitiveargs reports whether a comment is a golangci-lint nolint
...
// this analyzer by -- not the analyzer name "sensitiveargs"), ignoring any
// trailing "// explanation".
func nolintForSensitiveargs(text string) bool {
...
// nolintInfo records where sensitiveargs nolint directives appear in a file.
...
// whole file is suppressed, or a directive sits on any line the call spans.
