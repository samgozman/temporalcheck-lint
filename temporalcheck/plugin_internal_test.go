...
func TestNew(t *testing.T) {
	...
	want := []string{"execargs", "stringtarget", "optionsdiscard", "activitytimeout", "futureget", "lossynumber"}
...
func TestNew_Disabled(t *testing.T) {
	...
	if len(analyzers) != 6 {
		t.Fatalf("BuildAnalyzers returned %d analyzers, want 6", len(analyzers))
	}
}
