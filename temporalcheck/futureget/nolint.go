...
// nolintForFutureget reports whether a comment is a golangci-lint nolint
...
// this analyzer by -- not the analyzer name "futureget"), ignoring any trailing
// "// explanation".
func nolintForFutureget(text string) bool {
...
// nolintInfo records where futureget nolint directives appear in a file.
