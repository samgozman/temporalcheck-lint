...
// nolintForOptionsContext reports whether a comment is a golangci-lint nolint
...
// this analyzer by), ignoring any trailing "// explanation".
func nolintForOptionsContext(text string) bool {
...
// nolintInfo records where optionscontext nolint directives appear in a file.
