...
// nolintForWorkeroptions reports whether a comment is a golangci-lint nolint
...
// knows this analyzer by -- not the analyzer name "workeroptions"), ignoring any
// trailing "// explanation".
func nolintForWorkeroptions(text string) bool {
...
// nolintInfo records where workeroptions nolint directives appear in a file.
...
// anchors (the literal or one of its values) including literals written across
// several lines.
