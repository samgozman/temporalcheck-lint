...
// nolintForContinueAsNew reports whether a comment is a golangci-lint nolint
...
// this analyzer by -- not the analyzer name "continueasnew"), ignoring any
// trailing "// explanation".
func nolintForContinueAsNew(text string) bool {
...
// nolintInfo records where continueasnew nolint directives appear in a file.
...
// anchors (the call) including calls written across several lines.
