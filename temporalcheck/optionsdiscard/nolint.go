...
// nolintForOptionsdiscard reports whether a comment is a golangci-lint nolint
...
// knows this analyzer by -- not the analyzer name "optionsdiscard"), ignoring any
// trailing "// explanation".
func nolintForOptionsdiscard(text string) bool {
...
// nolintInfo records where optionsdiscard nolint directives appear in a file.
